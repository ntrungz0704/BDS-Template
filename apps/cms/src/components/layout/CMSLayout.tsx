                ...
                {userTenants.map((t: any) => (
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-[10px] text-white/40 truncate">{t.slug}.{PLATFORM_DOMAIN}</div>
                    </div>
                    {t.id === domainData?.tenantId && (
                          ...
                          <div className="flex items-start justify-between gap-2">
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="text-[11px] text-slate-400 mt-0.5 flex items-center gap-1">
                                ...
                                <span className="truncate">{t.slug}.{PLATFORM_DOMAIN}</span>
                              </div>
                            </div>
          ...
          {!hasTenant && (
            <div className="mb-6 p-6 sm:p-8 bg-white border border-amber-200 rounded-3xl shadow-sm text-center max-w-2xl mx-auto">
              ...
              <div className="mt-5 flex flex-wrap items-center justify-center gap-3">
                ...
                <a
                  href={process.env.NEXT_PUBLIC_MARKETPLACE_URL || 'https://aireviewbds.com/templates'}
