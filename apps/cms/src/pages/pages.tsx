                ...
                return (
                  ...
                  >
                    ...
                    <div className="px-5 py-3.5 bg-slate-50/70 border-t border-slate-100 flex items-center justify-between gap-2">
                      ...
                      <a
                        href={domainData?.customDomain ? `https://${domainData.customDomain}/${page.slug === 'home' ? '' : page.slug}` : `https://${domainData?.subdomain || 'hoanggialand'}.${(process.env.NEXT_PUBLIC_PLATFORM_DOMAIN || 'templates.aireviewbds.com')}/${page.slug === 'home' ? '' : page.slug}?tenant=${domainData?.subdomain || 'hoanggialand'}`}
                        target="_blank"
