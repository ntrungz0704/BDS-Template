        ...
        <div className="relative">
          <div className="flex items-start justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href={`https://${dashboardStatus?.subdomain || 'hoanggialand'}.${process.env.NEXT_PUBLIC_PLATFORM_DOMAIN || 'templates.aireviewbds.com'}/?tenant=${dashboardStatus?.subdomain || 'hoanggialand'}`}
                target="_blank"
