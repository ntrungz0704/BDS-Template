  ...
  const faqs = [
    {
      ...
      a: "Có! Với gói Mua Template BĐS chỉ từ 499.000đ - 499.000đ, bạn sở hữu vĩnh viễn 100% giao diện và mã nguồn đã chọn. Bạn có toàn quyền cấu hình, đăng bài và vận hành lâu dài."
    },
    {
    ...
    },
    {
      ...
      a: "Được chứ! Bạn chỉ cần chọn gói Template BĐS từ 499.000đ - 499.000đ, chúng tôi hỗ trợ đóng gói và chuyển giao toàn bộ mã nguồn ZIP hoặc hỗ trợ cài đặt thẳng lên máy chủ/hosting hiện có của bạn hoàn toàn miễn phí."
    }
  ];
            ...
            <div>
              ...
              <div className="mb-6">
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-xs font-bold text-blue-600 ml-1">/ CHỈ TỪ (499k - 499K)</span>
                </div>
