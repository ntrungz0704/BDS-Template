          ...
          {loading ? (
            ...
            <div className="max-w-3xl mx-auto bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-xl text-center animate-fadeIn">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full mt-8">
                ...
                <a
                  href={typeof window !== 'undefined' && window.location.hostname === 'localhost' ? `http://localhost:3000/site/${tenantSlug || orderData.subdomain || 'luxury-gold'}` : `https://${tenantSlug || orderData.subdomain || 'luxury-gold'}.${(process.env.NEXT_PUBLIC_PLATFORM_DOMAIN || 'templates.aireviewbds.com').replace(/^templates\./, '')}`}
                  target="_blank"
                  rel="noopener noreferrer"
