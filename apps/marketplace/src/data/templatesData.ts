...
// ─── PORTAL 01. BATDONGSAN CLASSIC PORTAL ──────────────────────────────────
  ...
  // ─── PORTAL 03. LUXURY REALTY PRESTIGE ─────────────────────────────────────
  {
    ...
    badgeColor: "#FFFFFF",
    accentColor: "#D97706",
    description: "Sàn phân phối bất động sản đất nền phân lô, đất vườn sinh thái và biệt thự đồi nghỉ dưỡng tại Bảo Lộc, Bảo Lâm, Di Linh - Lâm Đồng. Bố cục sàn giao dịch chuyên nghiệp với gam màu nâu gỗ trầm & vàng hổ phách tinh tế.",
    shortDescription: "Đất nền phân lô · Đất vườn nghỉ dưỡng · Bảo Lộc",
    ...
    features: [
      "Lưới 8 sản phẩm bất động sản phân lô, đất vườn sinh thái và biệt thự đồi",
      "Bộ lọc tìm kiếm 4 cấp độ: Danh mục, Khu vực, Mức giá, Diện tích",
      "Bất động sản theo 3 địa bàn trọng điểm: Bảo Lộc, Bảo Lâm, Di Linh",
      "3 Dự án nổi bật có sẵn sổ đỏ và quy hoạch hạ tầng đường nhựa",
      "Đầy đủ 6 trang con nghiệp vụ: Bán, Dự án, Tin tức, Giới thiệu, Liên hệ",
      "Tích hợp nút Hotline & Zalo tư vấn xem đất thực tế 24/7"
    ],
    priceBuy: 499000,
    priceBuySource: 1290000,
    priceRentMonthly: 129000,
    isActive: true,
    sortOrder: 3,
    targetAudience: ["Sàn phân phối BĐS Tây Nguyên & Lâm Đồng", "Đại lý phân phối đất nền phân lô F1", "Môi giới đất vườn sinh thái & Second Home"],
    highlights: ["Nâu Gỗ Trầm & Hổ Phách Sang Trọng", "Lưới 8 BĐS Thổ Cư Sẵn", "Bản Đồ 3 Vùng Lâm Đồng", "Đầy đủ 6 Trang Con"],
    availablePages: ["Trang chủ", "Nhà đất bán", "Chi tiết tin đăng", "Danh sách dự án", "Chi tiết dự án", "Tin tức BĐS", "Chi tiết tin tức", "Giới thiệu", "Liên hệ & Ký gửi"],
    modules: ["VipConciergeModule", "PropertyCardModule", "FeaturedProjectModule", "LocationFilterModule", "LeadCaptureModule"],
    benefits: ["Nâng cao uy tín sàn môi giới địa phương", "Tăng tỷ lệ khách liên hệ xem đất thực tế", "Đầy đủ 100% chức năng portal"],
    themeConfig: {
