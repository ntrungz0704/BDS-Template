...
export const TEMPLATE_SLUG_MAP: Record<string, { componentName: string; fileName: string; templateName: string }> = {
  'luxury-gold': { componentName: 'LuxuryTemplate', fileName: 'LuxuryTemplate.tsx', templateName: 'Luxury Gold' },
  'minimal-white': { componentName: 'MinimalTemplate', fileName: 'MinimalTemplate.tsx', templateName: 'Minimal White' },
  ...
  'urban-city': { componentName: 'ApartmentTemplate', fileName: 'ApartmentTemplate.tsx', templateName: 'Urban City' },
  'industrial-estate': { componentName: 'IndustrialTemplate', fileName: 'IndustrialTemplate.tsx', templateName: 'Industrial Estate' },
  'luxury-villa': { componentName: 'VillaTemplate', fileName: 'VillaTemplate.tsx', templateName: 'Luxury Villa' },
  'eco-living': { componentName: 'EcoTemplate', fileName: 'EcoTemplate.tsx', templateName: 'Eco Living' },
  'classic-heritage': { componentName: 'ClassicTemplate', fileName: 'ClassicTemplate.tsx', templateName: 'Classic Heritage' },
  'classic-elegant': { componentName: 'ClassicTemplate', fileName: 'ClassicTemplate.tsx', templateName: 'Classic Elegant' },
  'investment-pro': { componentName: 'InvestmentTemplate', fileName: 'InvestmentTemplate.tsx', templateName: 'Investment Pro' },
  'agency-onepage': { componentName: 'AgencyTemplate', fileName: 'AgencyTemplate.tsx', templateName: 'Agency Onepage' },
  'retail-commercial': { componentName: 'RetailTemplate', fileName: 'RetailTemplate.tsx', templateName: 'Retail Commercial' },
  'listing-portal': { componentName: 'ListingMarketplace', fileName: 'ListingMarketplace.tsx', templateName: 'Listing Portal' },
  'personal-agent': { componentName: 'PersonalAgentTemplate', fileName: 'PersonalAgentTemplate.tsx', templateName: 'Personal Agent' },
  'auction-bds': { componentName: 'AuctionTemplate', fileName: 'AuctionTemplate.tsx', templateName: 'Auction BĐS' },
  'land-plot': { componentName: 'LandPlotTemplate', fileName: 'LandPlotTemplate.tsx', templateName: 'Land Plot' },
};
