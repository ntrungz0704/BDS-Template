...
const projectSchema = z.zod.object({
  title: z.zod.string().min(2, 'Tiêu đề dự án tối thiểu 2 ký tự.'),
  slug: z.zod.string().min(2, 'Slug không được để trống.'),
  description: z.zod.string().optional(),
  shortDescription: z.zod.string().optional(),
  type: z.zod.enum(['APARTMENT', 'VILLA', 'TOWNHOUSE', 'LAND', 'COMMERCIAL', 'OFFICE']),
  status: z.zod.enum(['COMING_SOON', 'SELLING', 'SOLD_OUT']),
  price: z.zod.string().optional(),
  priceFrom: z.zod.coerce.number().optional(),
  priceTo: z.zod.coerce.number().optional(),
  area: z.zod.string().optional(),
  areaFrom: z.zod.coerce.number().optional(),
  areaTo: z.zod.coerce.number().optional(),
  address: z.zod.string().optional(),
  ward: z.zod.string().optional(),
  district: z.zod.string().optional(),
  city: z.zod.string().optional(),
  amenities: z.zod.array(z.zod.string()).optional().default([]),
  images: z.zod.array(z.zod.string()).optional().default([]),
  thumbnail: z.zod.string().optional(),
  featured: z.zod.coerce.boolean().optional().default(false),
