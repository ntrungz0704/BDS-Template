...
const CANONICAL_BDS_NAMES = [
  ...
  'Template #07 - Pannamera Eco-Village Bảo Lộc',
  'Template #08 - Industrial & Logistics Hub',
  'Template #09 - Heritage & Colonial Portal',
  'Template #10 - Investment & High Yield Portal',
  'Template #11 - Modern Villa & Waterfront Estate',
  'Template #12 - Mega Developer Ecosystem Portal',
  'Template #13 - Real Estate Auction & Liquidation Portal',
  'Template #14 - Landplot & Farmland Exchange Portal',
  'Template #15 - Commercial & Retail Podium Portal',
  'Template #16 - Elite Personal Broker Portal',
  'Template #17 - Northern Capital Heritage Portal',
  'Template #18 - Saigon Dynamic Riverfront Portal',
  'Template #19 - Central Coast Scenic Portal',
  'Template #20 - Mountain & Highland Retreat Portal',
  'Template #21 - Clean Minimal Scandinavian Portal',
  'Template #22 - Night Life & Commercial Strip Portal',
  'Template #23 - Luxury Penthouse & Sky Villa Portal',
  'Template #24 - Smart City & Future Living Portal',
] as const;
...
export async function syncCatalog() {
  ...
  // Đồng bộ lại tên chuẩn có số thứ tự cho các template legacy cũ trong DB
  ...
  for (const [legacySlug, canonicalName] of Object.entries(legacyAliases)) {
