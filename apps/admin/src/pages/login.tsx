    ...
    <div className="flex min-h-screen items-center justify-center bg-[#F8F6F3] px-4">
      <div className="w-full max-w-md rounded-xl bg-white p-8 shadow-md border border-[#E5E0D8]">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-[#1A1A2E]">SAAS PLATFORM</h1>
          <p className="mt-2 text-[#7F7F8F]">Quản trị hệ thống Marketplace & Tenant</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div>
            <label className="block text-sm font-semibold text-[#1A1A2E] mb-2">Email Đăng Nhập</label>
            <input
              type="email"
              {...register('email')}
