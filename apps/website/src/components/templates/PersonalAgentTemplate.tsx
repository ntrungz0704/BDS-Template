...
export default function PersonalAgentTemplate({ template, viewport = 'desktop', initialPage = 'home', company, theme: dynamicTheme, projects, posts }: TemplateProps) {
  ...
  const activePosts = posts && posts.length > 0
    ...
    : ((globalThis as any).__mockarticles_ref || []);

  // Shadowing variables
  const mockArticles: any = activePosts;
  ...
  const activeProjects = projects && projects.length > 0
    ...
    : ((globalThis as any).__featured_properties_ref || []);

  // Shadowing variables
  const FEATURED_PROPERTIES: any = activeProjects;
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Triết lý của tôi rất đơn giản: <strong>&ldquo;Bán nhà không chỉ là bán những bức tường, mà là bán phong cách sống và tầm nhìn tương lai.&rdquo;</strong> Tôi luôn đặt mình vào vị trí của khách hàng để tìm kiếm những tài sản phù hợp nhất với nhu cầu, sở thích và định hướng tài chính.
              </p>
