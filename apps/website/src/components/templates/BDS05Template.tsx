...
export default function BDS05Template({ template, viewport = 'desktop', initialPage = 'home', company, theme, projects, posts , pageContent }: TemplateProps) {
    ...
    <header className="w-full bg-white text-slate-800 sticky top-0 z-40 border-b border-slate-200 shadow-sm">
      <div className={`${MAX_W} mx-auto px-3 sm:px-4 py-2.5 sm:py-3 flex items-center justify-between gap-2 sm:gap-4`}>
        ...
        <button
          ...
          className="lg:hidden p-1.5 sm:p-2 text-slate-700 hover:bg-slate-100 rounded-md cursor-pointer ml-auto shrink-0 flex items-center justify-center"
