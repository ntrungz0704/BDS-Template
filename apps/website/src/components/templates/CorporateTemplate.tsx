    ...
    <header className="w-full bg-[#4A2810] text-white sticky top-0 z-40 shadow-md">
      ...
      <div className={`${MAX_W} mx-auto px-4 py-3 flex items-center justify-between`}>
        ...
        <button
          ...
          className="lg:hidden p-2 text-amber-300 hover:bg-white/10 rounded-md cursor-pointer ml-auto"
        >
    ...
    >
      <div>
        <div className="h-44 sm:h-48 relative overflow-hidden bg-slate-100">
          ...
          <span className="absolute bottom-2.5 right-2.5 px-2.5 py-0.5 bg-black/70 backdrop-blur-xs text-white font-bold text-[10px] rounded-md">
            {item.type}
          </span>
        </div>
