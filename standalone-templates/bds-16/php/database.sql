-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE TOP PERSONAL BROKER (BDS-16)
-- Tạo database: bds_personal_top_broker
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_personal_top_broker` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_personal_top_broker`;
