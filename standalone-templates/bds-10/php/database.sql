-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE INVESTMENT PRO HUB (BDS-10)
-- Tạo database: bds_investment_pro_hub
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_investment_pro_hub` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_investment_pro_hub`;
