...
<body class="w-full min-h-screen bg-white text-slate-900 font-sans flex flex-col justify-between selection:bg-amber-500 selection:text-slate-950">
        ...
        <header class="sticky top-0 z-40 bg-[#0B132B]/95 backdrop-blur-md text-white border-b border-amber-500/30 shadow-2xl transition-all">
            <div class="max-w-7xl mx-auto px-3 sm:px-4 py-2.5 sm:py-3.5 flex items-center justify-between gap-2 sm:gap-4">
                ...
                <div class="flex items-center gap-2 sm:gap-3 shrink-0 ml-auto">
                    <a href="tel:0919006030" class="hidden sm:flex items-center gap-1.5 px-3.5 py-2 rounded-sm bg-amber-500/10 border border-amber-500/40 text-[#FDE047] text-xs font-black whitespace-nowrap shrink-0 hover:bg-amber-500/20 transition">
            ...
            <section id="tong-quan" class="py-16 bg-[#FDFBF7] text-slate-800 border-b border-amber-200/60">
                <div class="max-w-7xl mx-auto px-4 space-y-10">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        ...
                        <div class="bg-white p-4 rounded-sm border border-amber-200/80 shadow-sm text-center space-y-1"><span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">Chủ Đầu Tư</span><p class="text-xs sm:text-sm font-black text-[#B45309]">Tập Đoàn An Viên</p></div>
            ...
            <section class="relative py-14 bg-slate-950 text-white overflow-hidden border-t border-amber-500/30">
                ...
                <div class="relative z-20 max-w-7xl mx-auto px-4 text-center space-y-6">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 items-center max-w-4xl mx-auto pt-2">
                        <div class="p-4 rounded-sm bg-white/10 backdrop-blur-md border border-white/20 text-center space-y-1"><span class="text-xs font-bold text-slate-400 block">Đơn vị phát triển</span><span class="text-sm font-black text-amber-300">AN VIÊN GROUP</span></div>
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="space-y-4">
                        ...
                        <p class="text-sm">Bán Đảo An Viên, TP. Nha Trang</p>
                        <p class="text-sm">Hotline: 0919 006 030</p>
                    </div>
                    <div class="space-y-4">
                ...
                <div class="mt-8 pt-8 border-t border-white/10 text-center text-xs">
                    &copy; 2026 An Viên Group. All rights reserved.
                </div>
            </div>
        </footer>
    </div>
    ...
    <div class="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
        <a href="https://zalo.me/0919006030" target="_blank" class="w-12 h-12 rounded-full bg-blue-500 text-white flex items-center justify-center shadow-lg hover:scale-110 transition cursor-pointer">
            <i data-lucide="message-square" class="w-6 h-6"></i>
        </a>
        <a href="tel:0919006030" class="w-12 h-12 rounded-full bg-amber-500 text-white flex items-center justify-center shadow-lg hover:scale-110 transition cursor-pointer">
