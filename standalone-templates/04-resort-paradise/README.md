# Resort Paradise Style — Standalone Real Estate Template

> **Mô tả:** BĐS biển · Biệt thự đảo · Condotel · Second Home  
> **Mã mẫu (Slug):** `resort-paradise`  
...
git commit -m "feat: initial commit for Resort Paradise Style real estate website"
