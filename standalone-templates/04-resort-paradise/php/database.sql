-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE RESORT PARADISE STYLE (SUNSHINE CITY) (BDS-04)
-- Tạo database: bds_resort_paradise
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_resort_paradise` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_resort_paradise`;
