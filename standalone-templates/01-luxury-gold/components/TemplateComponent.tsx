...
export default function LuxuryTemplate({ template, viewport = 'desktop', initialPage = 'home', company, theme, projects, posts }: TemplateProps) {
  ...
  const allPropertyList = useMemo(() => {
    ...
    return list;
  }, [currentPage, filterType, searchKeyword, sortBy]);
      ...
      <div className="bg-slate-50 border-b border-slate-100 text-xs py-1.5 px-4 text-slate-500">
        <div className={`${MAX_W} mx-auto flex justify-between items-center`}>
          <div className="flex items-center gap-4">
            <span className="hidden sm:inline">Công ty TNHH Bất động sản PlatformBDS</span>
            <span className="flex items-center gap-1"><Mail size={12} className="text-blue-600" /> hotro@webdemo.com</span>
          </div>
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1 font-bold text-slate-700">
              <Phone size={12} className="text-blue-600" /> 0905.56.xxxx
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-3 bg-gradient-to-b from-slate-900 to-blue-950 rounded-xl overflow-hidden p-6 text-white text-center flex flex-col justify-between relative shadow-lg">
            ...
            <div className="pt-6">
              ...
              <div className="text-[10px] text-slate-400 mt-2 font-mono">Hotline: 0905.56.xxxx</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 bg-white p-6 md:p-8 rounded-xl border border-slate-200 shadow-sm">
            ...
            <div className="lg:col-span-5 space-y-4">
              ...
              <div className="pt-4 space-y-2">
                ...
                <div className="text-center text-xs font-mono text-slate-500">Hotline: 0905.56.xxxx</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={`${MAX_W} mx-auto px-4 space-y-6 max-w-4xl`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-6 md:p-8 rounded-xl border border-slate-200 shadow-sm">
          <div className="space-y-4 text-xs text-slate-700">
            ...
            <p className="flex items-center gap-2"><Phone size={14} className="text-blue-600" /> Hotline: 0905.56.xxxx</p>
            <p className="flex items-center gap-2"><Mail size={14} className="text-blue-600" /> Email: webdemo@gmail.com</p>
          </div>
          <div className="space-y-3">
  ...
  // ── 10. FOOTER NEWSLETTER STRIP & 4-COLUMN FOOTER ───────────────────────────
  const renderFooter = () => (
        ...
        <div className={`${MAX_W} mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8`}>
          <div className="space-y-3">
            ...
            <p className="text-[11px] leading-relaxed">
              📍 Địa chỉ: 180 Hoàng Quốc Việt, Cầu Giấy, Hà Nội
            </p>
            <p className="text-[11px]">📞 Điện thoại: 0905.56.xxxx</p>
            <p className="text-[11px]">✉️ Email: webdemo@gmail.com</p>
          </div>
