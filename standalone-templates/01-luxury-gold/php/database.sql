-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE LUXURY GOLD STYLE (DINH THỰ HOÀNG GIA) (BDS-01)
-- Tạo database: bds_luxury_gold
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_luxury_gold` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_luxury_gold`;
