# HƯỚNG DẪN CÀI ĐẶT LP #06 - KHU ĐÔ THỊ CÔNG NGHIỆP & DỊCH VỤ VSIP (PHP & MYSQL)

## 1. Cài đặt trên XAMPP / Laragon
1. Copy toàn bộ thư mục `php` vào thư mục `htdocs` (VD: `C:/xampp/htdocs/lp-06`).
2. Mở phpMyAdmin (`http://localhost/phpmyadmin`), tạo database mới tên: `lp_06_db`.
3. Chọn tab Import và nạp file `database.sql`.
4. Truy cập `http://localhost/lp-06` để xem website hoạt động!
