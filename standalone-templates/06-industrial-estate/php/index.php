...
<head>
  ...
  <title>Industrial & Logistics Park — Website Bất Động Sản PHP & MySQL</title>
...
<body class="bg-slate-50 text-slate-800 antialiased min-h-screen flex flex-col justify-between">
  ...
  <main class="flex-1 w-full space-y-12 pb-16">
    <section class="py-16 px-4 bg-slate-900 text-white text-center">
      <h1 class="text-3xl sm:text-5xl font-black uppercase mb-4">Industrial & Logistics Park</h1>
      <p class="text-slate-300 max-w-xl mx-auto text-sm">Khu công nghiệp · Nhà xưởng xây sẵn · Kho vận B2B</p>
    </section>
