-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE RETAIL & SHOPHOUSE PODIUM (BDS-15)
-- Tạo database: bds_retail_shophouse_podium
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_retail_shophouse_podium` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_retail_shophouse_podium`;
