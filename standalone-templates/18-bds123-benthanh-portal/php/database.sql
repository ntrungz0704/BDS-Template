-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE BĐS 18 — SÀN GIAO DỊCH & ĐẤU GIÁ BẾN THÀNH (BDS-18)
-- Tạo database: bds_bds123_benthanh_portal
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_bds123_benthanh_portal` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_bds123_benthanh_portal`;
