-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE BĐS 22 — ZOHOTELS & HAPPY LAND NHA TRANG (BDS-22)
-- Tạo database: bds_happyland_zohotels_nhatrang
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_happyland_zohotels_nhatrang` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_happyland_zohotels_nhatrang`;
