-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE GREEN ECO LIVING (BDS-08)
-- Tạo database: bds_green_eco_living
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_green_eco_living` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_green_eco_living`;
