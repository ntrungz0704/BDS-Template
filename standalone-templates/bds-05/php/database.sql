-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE SMART URBAN CITY (AN VIÊN NHA TRANG) (BDS-05)
-- Tạo database: bds_smart_urban_city
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_smart_urban_city` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_smart_urban_city`;
