-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE BĐS 19 — SÀN NIÊM YẾT MẬT ĐỘ CAO NHÀ ĐẤT SỐ (BDS-19)
-- Tạo database: bds_nhadatso_density_portal
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_nhadatso_density_portal` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_nhadatso_density_portal`;
