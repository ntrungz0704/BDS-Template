-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE DỰ ÁN ĐẤT NỀN PHÂN LÔ (BDS-14)
-- Tạo database: bds_landplot_masterplan
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_landplot_masterplan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_landplot_masterplan`;
