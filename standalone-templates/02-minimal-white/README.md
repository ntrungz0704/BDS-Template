# Minimal White Style — Standalone Real Estate Template

> **Mô tả:** Apple Minimalist · Căn hộ cao cấp Bắc Âu · Tinh tế  
> **Mã mẫu (Slug):** `minimal-white`  
...
git commit -m "feat: initial commit for Minimal White Style real estate website"
