-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE MINIMAL WHITE STYLE (SÀN NOVIHOME) (BDS-02)
-- Tạo database: bds_minimal_white
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_minimal_white` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_minimal_white`;
