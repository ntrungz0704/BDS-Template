-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE BĐS 20 — CHUNG CƯ MINH KHAI & TIMES CITY (BDS-20)
-- Tạo database: bds_minhkhai_timescity
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_minhkhai_timescity` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_minhkhai_timescity`;
