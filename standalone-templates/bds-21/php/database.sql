-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE BĐS 21 — SÀN CHO THUÊ & MUA BÁN CHUNG CƯ HÀ NỘI (BDS-21)
-- Tạo database: bds_hanoi_rental_portal
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_hanoi_rental_portal` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_hanoi_rental_portal`;
