-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE BĐS 24 — REALTYBUILD TRANG TIN BĐS SỐ 1 VIỆT NAM (BDS-24)
-- Tạo database: bds_realtybuild_tech_portal
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_realtybuild_tech_portal` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_realtybuild_tech_portal`;
