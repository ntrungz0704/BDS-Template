# Mega Developer Portal — Standalone Real Estate Template

> **Mô tả:** Cổng thông tin Đa dự án · Quan hệ cổ đông Tập đoàn  
> **Mã mẫu (Slug):** `mega-developer-portal`  
...
git commit -m "feat: initial commit for Mega Developer Portal real estate website"
