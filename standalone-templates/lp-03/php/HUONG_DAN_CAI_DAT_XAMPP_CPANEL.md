# HƯỚNG DẪN CÀI ĐẶT LP #03 - ĐẤT NỀN PHÂN LÔ F0 SỔ ĐỎ TRAO TAY (PHP & MYSQL)

## 1. Cài đặt trên XAMPP / Laragon
1. Copy toàn bộ thư mục `php` vào thư mục `htdocs` (VD: `C:/xampp/htdocs/lp-03`).
2. Mở phpMyAdmin (`http://localhost/phpmyadmin`), tạo database mới tên: `lp_03_db`.
3. Chọn tab Import và nạp file `database.sql`.
4. Truy cập `http://localhost/lp-03` để xem website hoạt động!
