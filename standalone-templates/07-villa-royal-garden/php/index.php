...
<head>
  ...
  <title>Villa Royal Garden — Website Bất Động Sản PHP & MySQL</title>
...
<body class="bg-slate-50 text-slate-800 antialiased min-h-screen flex flex-col justify-between">
  ...
  <main class="flex-1 w-full space-y-12 pb-16">
    <section class="py-16 px-4 bg-slate-900 text-white text-center">
      <h1 class="text-3xl sm:text-5xl font-black uppercase mb-4">Villa Royal Garden</h1>
      <p class="text-slate-300 max-w-xl mx-auto text-sm">Biệt thự đơn lập sân vườn · Sơ đồ mặt bằng · 3D Tour</p>
    </section>
