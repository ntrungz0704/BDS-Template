# Villa Royal Garden — Standalone Real Estate Template

> **Mô tả:** Biệt thự đơn lập sân vườn · Sơ đồ mặt bằng · 3D Tour  
> **Mã mẫu (Slug):** `villa-royal-garden`  
...
git commit -m "feat: initial commit for Villa Royal Garden real estate website"
