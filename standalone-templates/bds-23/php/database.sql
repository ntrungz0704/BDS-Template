-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE BĐS 23 — SÀN GIAO DỊCH NHÀ PHỐ HOMEO (BDS-23)
-- Tạo database: bds_homeo_agency_multithumb
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_homeo_agency_multithumb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_homeo_agency_multithumb`;
