-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE GRAND RIVERSIDE ECO-TOWNSHIP (BDS-06)
-- Tạo database: bds_industrial_estate
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_industrial_estate` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_industrial_estate`;
