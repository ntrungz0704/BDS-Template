...
<head>
  ...
  <title>Grand Riverside Eco-Township — Website Bất Động Sản PHP & MySQL</title>
...
<body class="bg-slate-50 text-slate-800 antialiased min-h-screen flex flex-col justify-between">
  ...
  <main class="flex-1 w-full space-y-12 pb-16">
    <section class="py-16 px-4 bg-slate-900 text-white text-center">
      <h1 class="text-3xl sm:text-5xl font-black uppercase mb-4">Grand Riverside Eco-Township</h1>
      <p class="text-slate-300 max-w-xl mx-auto text-sm">Đại đô thị sinh thái 120ha · Căn hộ & Shophouse · Hồ cảnh quan 12ha</p>
    </section>
  ...
  <footer class="w-full bg-[#07132B] text-slate-300 text-xs pt-12 pb-6 border-t border-slate-800">
    ...
    <div class="max-w-7xl mx-auto px-4 pt-6 text-center text-[11px] text-slate-400">
      <p>© 2026 Bản quyền thuộc về <strong class="text-white">TEMPLATEBDS</strong> — Mẫu Giao Diện: BDS-06.</p>
    </div>
  </footer>
