# Smart Urban City — Standalone Real Estate Template

> **Mô tả:** Căn hộ chung cư · Đại đô thị thông minh · Metro  
> **Mã mẫu (Slug):** `smart-urban-city`  
...
git commit -m "feat: initial commit for Smart Urban City real estate website"
