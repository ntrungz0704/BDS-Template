...
<head>
  ...
  <title>Smart Urban City (An Viên Nha Trang) — Website Bất Động Sản PHP & MySQL</title>
...
<body class="bg-slate-50 text-slate-800 antialiased min-h-screen flex flex-col justify-between">
  ...
  <header class="bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm">
    <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
      <a href="index.php" class="font-black text-xl text-blue-600 uppercase">
        Smart Urban City (An Viên Nha Trang)
      </a>
  ...
  <main class="flex-1 w-full space-y-12 pb-16">
    <section class="py-16 px-4 bg-slate-900 text-white text-center">
      <h1 class="text-3xl sm:text-5xl font-black uppercase mb-4">Smart Urban City (An Viên Nha Trang)</h1>
      <p class="text-slate-300 max-w-xl mx-auto text-sm">Căn hộ chung cư · Đại đô thị thông minh · Metro</p>
    </section>
  ...
  <footer class="w-full bg-[#07132B] text-slate-300 text-xs pt-12 pb-6 border-t border-slate-800">
    ...
    <div class="max-w-7xl mx-auto px-4 pt-6 text-center text-[11px] text-slate-400">
      <p>© 2026 Bản quyền thuộc về <strong class="text-white">TEMPLATEBDS</strong> — Mẫu Giao Diện: BDS-05.</p>
    </div>
  </footer>
