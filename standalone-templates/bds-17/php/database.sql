-- ========================================================
-- DATABASE SCHEMA CHO TEMPLATE BĐS 17 — CỔNG THÔNG TIN BẤT ĐỘNG SẢN SỐ 1 (BDS-17)
-- Tạo database: bds_portal_bds_so1
-- ========================================================

CREATE DATABASE IF NOT EXISTS `bds_portal_bds_so1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `bds_portal_bds_so1`;
