...
const TEMPLATES = [
  ...
  { num: '11', slug: 'agency-marketing-onepage', name: 'Agency Marketing OnePage', compFile: 'BDS11Template.tsx', desc: 'Landing page 1 trang · Tối ưu chạy Ads · Chuyển đổi cao' },
  { num: '12', slug: 'mega-developer-portal', name: 'Mega Developer Portal', compFile: 'BDS12Template.tsx', desc: 'Cổng thông tin Đa dự án · Quan hệ cổ đông Tập đoàn' },
  { num: '13', slug: 'auction-platform', name: 'Sàn Đấu Giá BĐS', compFile: 'BDS13Template.tsx', desc: 'Đấu giá trực tuyến · Countdown · Tài sản phát mãi ngân hàng' },
  { num: '14', slug: 'landplot-masterplan', name: 'Dự Án Đất Nền Phân Lô', compFile: 'BDS14Template.tsx', desc: 'Đất nền phân lô · Sơ đồ quy hoạch 1/500 · Báo giá F1' },
  { num: '15', slug: 'retail-shophouse-podium', name: 'Retail & Shophouse Podium', compFile: 'BDS15Template.tsx', desc: 'Shophouse khối đế · Mặt bằng kinh doanh · TTTM' },
  { num: '16', slug: 'personal-top-broker', name: 'Top Personal Broker', compFile: 'BDS16Template.tsx', desc: 'Profile thương hiệu cá nhân · Môi giới triệu đô · One Page' },
  { num: '17', slug: 'portal-bds-so1', name: 'BĐS 17 — Cổng Thông Tin Bất Động Sản Số 1', compFile: 'BDS17Template.tsx', desc: 'Cổng tin BĐS số 1 · Mua bán & Cho thuê · Tính lãi vay' },
  { num: '18', slug: 'bds123-benthanh-portal', name: 'BĐS 18 — Sàn Giao Dịch & Đấu Giá Bến Thành', compFile: 'BDS18Template.tsx', desc: 'Sàn Đấu Giá Bến Thành · Phân tầng khu vực · Lưới 4 cột' },
  { num: '19', slug: 'nhadatso-density-portal', name: 'BĐS 19 — Sàn Niêm Yết Mật Độ Cao Nhà Đất Số', compFile: 'BDS19Template.tsx', desc: 'Mật độ cao · Lọc 6 tiêu chí · Phong thủy nhà đất' },
  { num: '20', slug: 'minhkhai-timescity', name: 'BĐS 20 — Chung Cư Minh Khai & Times City', compFile: 'BDS20Template.tsx', desc: 'Chung cư Minh Khai · Times City · FAQ Accordion' },
  { num: '21', slug: 'hanoi-rental-portal', name: 'BĐS 21 — Sàn Cho Thuê & Mua Bán Chung Cư Hà Nội', compFile: 'BDS21Template.tsx', desc: 'Cho thuê chung cư Hà Nội · 5 Quận trọng điểm · Giá tốt' },
  ...
  <header class="bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm">
    <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        <a href="tel:0919006030" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-full shadow transition">
          📞 0919 006 030
        </a>
      </div>
    </div>
